...
class GetImagesTest(ImagesV2Fixture):
    ...
    def test_get_images_by_name_sort_key(self):
        ...
        for i in range(0, len(images) - 1):
            ...
            i += 1
            next_image = images[i]
            self.assertTrue(next_image.name <= image.name)
    ...
    def test_get_images_by_status_sort_key(self):
        ...
        for i in range(0, len(images) - 1):
            ...
            i += 1
            next_image = images[i]
            self.assertTrue(next_image.status <= image.status)
    ...
    def test_get_images_by_container_format_sort_key(self):
        ...
        for i in range(0, len(images) - 1):
            ...
            next_image = images[i]
            self.assertTrue(
                next_image.container_format <= image.container_format)
    ...
    def test_get_images_by_disk_format_sort_key(self):
        ...
        for i in range(0, len(images) - 1):
            ...
            next_image = images[i]
            self.assertTrue(
                next_image.disk_format <= image.disk_format)
    ...
    def test_get_images_by_created_at_sort_key(self):
        ...
        for i in range(0, len(images) - 1):
            ...
            next_image = images[i]
            self.assertTrue(
                next_image.created_at <= image.created_at)
    ...
    def test_get_images_by_updated_at_sort_key(self):
        ...
        for i in range(0, len(images) - 1):
            ...
            next_image = images[i]
            self.assertTrue(
                next_image.updated_at <= image.updated_at)
    ...
    def test_get_images_by_pagination_marker(self):
        ...
        self.assertEqual(images_list[1:], images)
    ...
    @tags(type='negative', net='no')
    def test_get_images_using_incorrect_url(self):
        """Get images with an incorrect URL."""
        response = self.rest_client.get(
            '{0}/imagess'.format(self.images_endpoint))
        self.assertEqual(response.status_code, 404)

    @tags(type='negative', net='no')
    def test_get_images_using_method_mismatch_of_put(self):
        """Get images with a method mismatch."""
        response = self.rest_client.put(
            '{0}/images'.format(self.images_endpoint))
        self.assertEqual(response.status_code, 404)
